...
<div class="row">
    ...
    <div class="col-12 px-0">
        <div>
            <button type="button" class="btn btn-block sub-offices btn-outline-dark" data-toggle="collapse" data-target="#subOffices" aria-expanded="false" aria-controls="subOffices">
