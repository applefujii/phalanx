...
use App\Models\AltAptitudeQuestion;
use App\Models\Office;
use App\Http\Requests\AptitudeQuestionFormRequest;
use Carbon\Carbon;

class AltAptitudeQuestionFormController extends Controller
{
    /**
     * 質問フォーム画面
     *
    ...
    {
        $aptitude_questions = AltAptitudeQuestion::whereNull('deleted_at')->orderBy('sort')->get();
    ...
    public function calculate(AptitudeQuestionFormRequest $request)
    {
        ...
        $aptitude_questions = AltAptitudeQuestion::select('scores')->whereNull('deleted_at')->orderBy('sort')->get();
