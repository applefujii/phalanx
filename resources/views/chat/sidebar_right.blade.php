...
@foreach ($user_types as $user_type)
    <div class="row">
        @foreach ($offices as $office)
            <div>
                <a data-toggle="collapse" class="no-close" @if($user_type->id === 1)href="#staff-{{ $office->id }}" @elseif ($user_type->id === 2) href="#user-{{ $office->id }}" @else href="#trial-{{ $office->id }}" @endif>
