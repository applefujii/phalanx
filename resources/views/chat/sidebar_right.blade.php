...
@foreach ($user_types as $user_type)
    <div class="row">
        @foreach ($offices as $office)
            <div>
                <a data-toggle="collapse" @if($user_type->id === 1)href="#staff-{{ $office->id }}" @else href="#user-{{ $office->id }}"@endif>
                ...
                <ul @if($user_type->id === 1)id="staff-{{ $office->id }}" @else id="user-{{ $office->id }}"@endif class="col-12 pt-1 collapse show">
