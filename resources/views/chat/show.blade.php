    ...
    <div id="chat_main">
        ...
        <div id="chat_footer" class="border col-md-8 d-flex align-items-center p-0">
            <div class="form-row col-12">
                ...
                <div class="col-1">
                    <button id="submit" class="btn btn-primary"><svg xmlns="{{ asset('image/send-fill.svg') }}" width="16" height="16" fill="currentColor" class="bi bi-send-fill" viewBox="0 0 16 16">
