...
--}}
    ...
    <script>
        //カラム数 ※仮で4 画面サイズに応じて変動
        var peopleColumn = 4;
        //1カラムの人数
        var oneColumnNumber = Math.floor(11/4) +1;   //※総人数取得
        //チェックされている人のID
        var checkList = [];
        // ※所属事務所の取得
        var myOffice = "maple";
        ...
        $(document).ready(function(){
            $(document).on('shown.bs.modal','#peopleListModal', function ( event ) {
                ...
                $.each(office, function(index, element){
                    ...
                    // 全てにチェックが付いていたら全チェックをcheckedにする
