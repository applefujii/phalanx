  ...
  <div class="pagelayout">
    <div class="buttons-container">
      <div class="buttons-first-column">
        ...
        <button class="btn @if ($new_trial_applications) btn-warning @else btn-primary @endif" onclick="location.href='{{ route("trial_application_manage.index") }}'">体験・見学申込一覧</button>
      </div>
