...
<div class="container">
    ...
    <a href="{{ route('notification.create') }}" type="button" class="btn btn-primary" style="margin: 10px;">新規作成</a>
        ...
        <tbody>
            @foreach($notifications as $notification)
                <tr>
                    ...
                    <td><div style="text-align: center"><a href="{{ route('notification.edit', $notification->id) }}" type="button" class="btn btn-primary" style="margin-right: 13%; max-width: 30%; min-width: 40px; display: inline;">編集</a><form style="display: inline;"><input hidden value="1"><input type="submit" value="削除" class="btn btn-danger" style="max-width: 30%; min-width: 40px; white-space: normal;"></form></td>
                </tr>
            @endforeach
        </tbody>
    </table>
