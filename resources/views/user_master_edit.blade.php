...
<div class="container">
    ...
    <form method="post" action="{{ route('user.update', $user->id) }}">
        ...
        <div class="form-group">
            <div class="row justify-content-start mx-auto my-4">
                <div style="width: 33%">
                    ...
                    <input type="text" id="name" style="width: 100px;" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name', $user->name) }}" required autofocus>
                    @error('name')
                ...
                <div style="width: 33%">
                    ...
                    <input type="text" id="name_katakana" style="width: 100px;" class="form-control @error('name_katakana') is-invalid @enderror" name="name_katakana" value="{{ old('name_katakana', $user->name_katakana) }}" required>
                    @error('name_katakana')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="row justify-content-start mx-auto my-4">
                <div style="width: 33%">
                    ...
                    <input type="text" id="login_name" style="width: 100px;" class="form-control @error('login_name') is-invalid @enderror" name="login_name" value="{{ old('login_name', $user->login_name) }}" required>
                    @error('login_name')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div style="width: 33%">
                    ...
                    <input type="password" id="password" style="width: 100px;" class="form-control @error('password') is-invalid @enderror" name="password" required>
                    @error('password')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
        ...
        <input type="submit" class="btn btn-primary" value="更新"><a href="{{ route('user.index') }}" style="margin-left: 100px;"class="btn btn-secondary">戻る</a>
    </form>
</div>
